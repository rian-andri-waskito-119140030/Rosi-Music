        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src={{ URL::asset('assets/images/logo.png')}} alt="Chain App Dev">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              ...
              {{-- <?php var_dump(Auth::guard('pelanggan')); ?> --}}
              <ul class="navbar-nav ms-auto">
                @auth
                {{-- <?php dd(Auth::guard('pelanggan')); ?> --}}
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      Welcome back, {{ Auth::guard('pelanggan')->user->attributes->name }}
                    </a>
                ...
                @else
                <li class="nav-item">
                    {{-- <a href="/auth/google" class="nav-link {{ ($active === "login") ? 'active' : '' }}"><i class="bi bi-box-arrow-in-right"></i> Login</a> --}}
                    <li><div class="gradient-button"><a id="modal_trigger" href="/auth/google"><i class="fa fa-sign-in-alt"></i> Sign In Now</a></div></li>
                </li>
              @endauth
            </ul>
              {{-- <li><div class="gradient-button"><a id="modal_trigger" href="/auth/google"><i class="fa fa-sign-in-alt"></i> Sign In Now</a></div></li>  --}}
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="right-image">
            <img src={{ URL::asset('assets/images/about-right-dec.png')}} alt="">
          </div>
        </div>
      </div>
    </div>
