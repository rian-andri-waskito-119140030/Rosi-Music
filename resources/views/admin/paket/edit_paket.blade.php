          ...
          <div class="block block-rounded">
            ...
            <div class="block-content">
              <div class="row m-auto">
                <div class="col-lg-12">
                  <form
                    action="/admin/paket/edit/{{ $paket->id_paket }}"
                    method="POST"
                    ...
                    <div class="row g-4">
                      <div class="col-6">
                        ...
                        <select
                          ...
                          @foreach ($jenis_paket as $item)
                          <option value="{{ $item->id_jenis_paket }}" <?php if($item->id_jenis_paket == $paket->id_jenis_paket) {echo "selected"; } ?>>{{ $item->jenis_paket }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-6">
                      ...
                      <div class="col-6 mb-4">
                        ...
                        <textarea
                          ...
                          >{{ $paket->deskripsi_panjang }}</textarea>
                      </div>
                      <div class="col-6">
                        <label
                          class="form-label"
                        ...
                        <textarea
                          ...
                          rows="4">{{ $paket->deskripsi_singkat }}</textarea>
                      </div>
                    </div>
