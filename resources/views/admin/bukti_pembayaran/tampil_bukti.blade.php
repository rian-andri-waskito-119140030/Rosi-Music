...
@section('style')
    ...
    <link
      rel="stylesheet"
      href="assets/js/plugins/magnific-popup/magnific-popup.css" />
...
{{-- <?php dd($data); ?> --}}
                                              ...
                                              <div class="row items-push js-gallery img-fluid-200">
                                                  <div class="col-md-6 col-lg-4 col-xl-3 animated fadeIn">
                                                    <a
                                                      ...
                                                      href="{{ URL::asset("storage/bukti_pembayaran/")}}/{{ $item->bukti }}">
                                                      <img
                                            ...
                                            <td class="text-center fs-sm">
                                              <form action="/admin/bukti-pembayaran/validasi" method="POST">
                                                ...
                                                <a
                                                  ...
                                                  href="{{ route('bukti-pembayaran.edit', $item->id_bukti_pembayaran) }}"
                                                  data-bs-toggle="tooltip"
                                                  title="Edit">
    ...
    <!-- Page JS Code -->
    <script src={{ URL::asset("assets/js/pages/bukti_pembayaran/be_tables_datatables.min.js")}}></script>
    <script>
      One.helpersOnLoad([
        "js-flatpickr",
        "jq-datepicker",
