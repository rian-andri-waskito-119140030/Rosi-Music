          ...
          <div class="block block-rounded">
            ...
            <div class="block-content">
              <div class="row m-auto">
                <div class="col-lg-12">
                  <form
                    action="be_pages_ecom_product_edit.html"
                    method="POST"
                    onsubmit="return false;">
                    <div class="mb-4">
                      <label class="form-label" for="one-ecom-product-id" hidden
                        >PID</label
                      >
                      <input
                        type="text"
                        class="form-control"
                        id="one-ecom-product-id"
                        name="one-ecom-product-id"
                        value="789"
                        readonly
                        hidden />
                    </div>
                    <div class="row g-4">
                      ...
                      <div class="col-6">
                        ...
                        <input
                          type="text"
                          class="form-control"
                          placeholder="{{ $paket->jenis_paket->jenis_paket }}"
                          readonly />
                      </div>
                      <div class="col-6">
                        ...
                        <input
                          type="text"
                          class="form-control"
                          placeholder="{{ $pesanan->pesanan->tanggal_booking }}"
                          readonly />
                      </div>
                      <div class="col-6">
                      ...
                      <div class="col-6">
                        ...
                        <input
                          type="text"
                          class="form-control"
                          placeholder="{{ $pesanan->pesanan->tanggal_selesai }}"
                          readonly />
                      </div>
                      <div class="col-6">
