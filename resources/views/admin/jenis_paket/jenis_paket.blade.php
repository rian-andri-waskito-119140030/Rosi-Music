...
@section('konten')
        ...
        <div class="content">
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">Data Jenis Paket</h3>
            </div>
                  ...
                  <table
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="fw-semibold fs-sm">{{ $item->id_jenis_paket }}</td>
                        <td class="d-none d-sm-table-cell fs-sm">{{ $item->jenis_paket }}</td>
                        <td class="d-none d-sm-table-cell"><img
                          style="width: 71px; height: 107px"
                          src='{{ URL::asset("storage/jenis_paket")}}/{{ $item->gambar }}' /></td>
                        <td class="d-none d-sm-table-cell fs-sm">{{ $item->deskripsi }}</td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
    ...
    <!-- Page JS Code -->
    <script src={{  URL::asset("assets/js/pages/jenis_paket/be_tables_datatables.min.js") }}></script>
@endsection 