            ...
            <div class="col-6 col-lg-3">
              <a
                ...
                <div class="block-content py-2 bg-body-light">
                  <p class="fw-medium fs-sm text-success mb-0">Tambah Barang</p>
                </div>
              </a>
            </div>
          </div>
                  ...
                  <table
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="fw-semibold fs-sm">{{ $item->id_barang }}</td>
                        ...
                        <td class="text-center fs-sm">
                          <img
                            ...
                            src='{{ URL::asset("storage/barang")}}/{{ $item->gambar }}' />
                        </td>
                        ...
                        <td class="text-center fs-sm">
                          <a
                            ...
                            href="/admin/barang/edit/{{ $item->id_barang }}"
