          ...
          <div class="block block-rounded">
            ...
            <div class="block-content">
              <div class="row m-auto">
                <div class="col-lg-12">
                  <form
                  action="/admin/barang/edit/{{ $barang->id_barang }}"
                  method="POST"
                    ...
                    <div class="row g-4">
                      ...
                      <div class="col-6">
                        ...
                        <select
                          ...
                          @foreach ($jenis_barang as $item)
                            <option  value="{{ $item->id_jenis_barang }}" <?php if($item->id_jenis_barang == $barang->id_jenis_barang) {echo "selected"; } ?>>{{ $item->jenis_barang }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-6">
                      ...
                      <div class="col-6 mb-4">
                        ...
                        <select
                          ...
                          <option value="Diperbaiki" <?php if($barang->kondisi == "Diperbaiki") {echo "selected"; } ?> >Diperbaiki</option>
                        </select>
                      </div>
                    </div>
