          ...
          <div class="col-12">
            <nav class="main-nav">
              ...
              <ul class="nav">
                ...
                @auth
                <li>
                  <link rel="stylesheet" href={{ URL::asset("assets/css/tentang-kami-login.css")}} />
                  <div class="">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div
                  ...
                  data-wow-duration="1s"
                  data-wow-delay="0.5s">
                  <img src="assets/images/logo-rm.png" alt="" />
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      <p>
                        ...
                        berbagai klient dalam membantu mensukseskan berbagai
                        acara. Rosi music juga mempunyai crew crew yang sudah
                        berpengalaman di bidang musik selama bertahun tahun dan
                        selalu memberikan pelayanan yang terbaik. Rosi music
                        mempunyai 4 kategori paket yaitu pake non-MC, paket
                        non-Diessel, paket Non-MC & Non-Diessel dan juga paket
                        yang versi lengkap. Tiap paket mempunyai lebih dari 10
                        pilihan paket yang isi nya bervariasi mulai dari paket
                        sound system, teknisi, AJS, ranjer, kendaraan
                        transsportasi, dan juga MC.
                      </p>
                    </div>
                  </div>
                </div>
